...
import {
  labExtractionSchema,
  LabExtractionFormData,
} from "../../types/galeryOne/labExtractionSchema";
...
export function LabExtractionScreen() {
  ...
  const onSubmit = async (data: LabExtractionFormData) => {
    ...
    try {
      ...
      await api.post("/lab-extractions", payload);
        ...
        >
          <View style={styles.formSection}>
            ...
            <Text style={styles.sectionSubtitle}>
              Preencha as informações da análise de extração
            </Text>
          </View>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.seqCard}>
              ...
              <TouchableOpacity
                style={styles.seqAddBtn}
                onPress={() => addSeq({ inicio: 0, fim: 0 })}
              >
