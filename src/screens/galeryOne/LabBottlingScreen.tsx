...
import {
  LabBottlingFormData,
  labBottlingSchema,
} from "../../types/galeryOne/labBottlingSchema";
...
export function LabBottlingScreen() {
  ...
  const onSubmit = async (data: LabBottlingFormData) => {
    ...
    try {
      ...
      await api.post("/lab-bottling", payload);
        ...
        >
          <View style={styles.formSection}>
            ...
            <Text style={styles.sectionSubtitle}>
              Preencha as informações da análise de envase
            </Text>
          </View>
