...
export function BottleControlScreen() {
  ...
  const onSubmit = async (data: BottleControlFormData) => {
    ...
    try {
      ...
      await api.post("/bottle-control", payload);
                ...
                <View key={field.id} style={styles.dynamicCard}>
                  ...
                  <View style={styles.row}>
                    <InputGroup
                      ...
                      name={`insumos.${index}.modelo_garrafa`}
                      placeholder="Tipo/Capacidade"
                    />
                    <InputGroup
                      control={control}
                      label="Lote da Garrafa"
                      name={`insumos.${index}.lote_garrafa`}
                  ...
                  <View style={{ marginTop: 12 }}>
                    ...
                    <View style={styles.barcodeContainer}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => handleScanBarcode(index)}
                        activeOpacity={0.7}
                      >
                        <MaterialCommunityIcons
                          name="barcode-scan"
