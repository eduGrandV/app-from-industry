...
import {
  raisinMonitoringSchema,
  RaisinMonitoringFormData,
} from "../../types/galleryFour/raisinMonitoringSchema";
...
export function RaisinMonitoringScreen() {
  ...
  const { control, reset, handleSubmit } = useForm<RaisinMonitoringFormData>({
  ...
  const onSubmit = async (data: RaisinMonitoringFormData) => {
        ...
        >
              ...
              <View style={styles.row}>
                <View style={{ flex: 1 }}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => setShowDatePickerIni(true)}
                  >
                    <MaterialIcons
                      name="calendar-today"
                      size={16}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionBody}>
              ...
              <View style={[styles.row, { marginTop: 12 }]}>
                <InputGroup
                  label="Qtd. Embalagem (Un)"
                  name="qtd_embalagem_un"
                  keyboard="numeric"
                />
              </View>
            </View>
          ...
          <View style={styles.card}>
            <InputGroup
              ...
              name="observacao"
              placeholder="Ex: Anomalias na secagem..."
            />
